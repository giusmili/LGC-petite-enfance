...
export default defineConfig({
  // Base par défaut pour déploiement à la racine
  base: '/',
  ...
  plugins: [
    ...
    VitePWA({
      ...
      // tu gardes ton propre webmanifest (public/favicon/site.webmanifest)
      manifest: false,
      includeAssets: [
      ...
      workbox: {
        // Assure-toi d'avoir bien un public/offline.html
  ...
  build: {
    target: 'esnext',
    outDir: 'build',      // <- sortie cohérente pour Vercel
